...
#
# FCM: centroides diferentes para cada rodada
#
###############################################################################
...
setwd("resultados/")
write.csv(final, paste("contral - ",toupper(fcm.method)," - centroides diferentes",ifelse(SEM.FINAL.DE.SEMANA," fdsOUT",""),".csv",sep=""), row.names=FALSE)
