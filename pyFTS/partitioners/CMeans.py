...
def c_means(k, dados, tam, max_iter, patience):
    ...
    # para cada instância
    iteracoes = 0
    while iteracoes < max_iter and it_semmodificacao < patience:
        inst_count = 0
...
class CMeansPartitioner(partitioner.Partitioner):
    ...
    def build(self, data):
        ...
        centroides = c_means(self.partitions, data, 1, self.max_iter)
