...
Original file is located at
    https://colab.research.google.com/drive/1ZU6lBYbNrrp9B-XsLSI9-To0As_1qnCK
"""
...
model=ga(function=runModel,dimension=15,variable_type='int',variable_boundaries=varbound)
